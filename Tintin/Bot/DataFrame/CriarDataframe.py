...
def velas(a):
    klines = client.get_historical_klines(a, Client.KLINE_INTERVAL_5MINUTE , "2019-02-07T19:25" ,"2019-02-09T00:05"  )
    close=[]
    open1=[]
    low=[]
    high=[]
...
def datapandas (a):
    ...
    df.to_csv(r'C:\Users\hugom\Desktop\Projecto\DataFrame\s40.csv', index=False)
