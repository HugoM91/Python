...
import talib
from talib.abstract import RSI, MACD, ADX, ATR , BBANDS , MA , WCLPRICE, AVGPRICE, STOCHRSI
import numpy as np
...
def indicadores (o , c , h , l) : # open, close, high , low
    ...
    return rsi , adx , atr , ma50 , ma100, ma500, wcl, macd, macdsignal, macdhist, upperband, middleband, lowerband, avg, fastk, fastd
