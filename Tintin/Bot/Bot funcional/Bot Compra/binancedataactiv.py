...
def datapandas (a):
    ...
    rsi, adx, atr, ma50, ma100, ma500, wlc, macd, macdsignal, macdhist, upperband, middleband, lowerband, avg, fastk, fastd = indicadores (open1 , close , high , low)
