...
def velas(a):
    klines = client.get_historical_klines(a, Client.KLINE_INTERVAL_5MINUTE , "2020-01-17T03:50" ,"2020-01-18T13:20"  )
...
def datapandas (a):
    ...
    df.to_csv(r'C:\Users\hugom\Desktop\Projecto\DataFrame\1.csv', index=False)
