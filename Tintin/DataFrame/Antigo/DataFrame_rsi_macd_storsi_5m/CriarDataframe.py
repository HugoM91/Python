...
def velas(a):
    klines = client.get_historical_klines(a, Client.KLINE_INTERVAL_5MINUTE , "2020-04-05T08:55" ,"2020-04-05T20:15")
    close=[]
    open1=[]
    low=[]
    high=[]
