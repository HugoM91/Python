...
df1 = pd.read_csv('alt_buy_random_final.csv')


df2 = pd.read_csv('basedados2.csv')
"""
df3 = pd.read_csv('alt_random_final3.csv')
...
df_row.to_csv(r'C:\Users\hugom\Desktop\Projecto\DataFrame\alt_btc_final.csv', index=False)
