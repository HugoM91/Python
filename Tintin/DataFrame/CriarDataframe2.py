...
def velas(a , l , l1):
    klines = client.get_historical_klines(a, Client.KLINE_INTERVAL_1MINUTE , l , l1)
    close=[]
    open1=[]
    low=[]
    high=[]
...
def datapandas (a, g , l, l1):
    close, open1, low, high, volume, nr_trocas, close_time, open_time = velas(a, l, l1)
    ...
    df = pd.DataFrame({'p1': listapandas(wlc)[0], 'p2':listapandas(wlc)[1], 'p3':listapandas(wlc)[2],
                       ...
                       'Pred':pred},columns = ['p1','p2', 'p3','p4','p5','p6','p7',
                                                                              ...
                                                                              'ad10' ,'ad11' ,'ad12' ,'ad13' ,'ad14' ,'ad15' ,'Pred'])
                                                                              
    df.to_csv(g , index=False)

    
def datapandas2 (a, g , l, l1):
    close, open1, low, high, volume, nr_trocas, close_time, open_time = velas(a, l, l1)
    rsi, adx, atr, ma50, ma100, ma200, wlc, macd, macdsignal, macdhist, upperband, middleband, lowerband, avg, fastk, fastd, ad = indicadores (open1 , close , high , low, volume)
    macddif=[]
    stodif=[]
...
def start(a , b):
    datapandas('BTCUSDT', r'C:\Users\hugom\Desktop\Projecto\DataFrame\com_ad\r55.csv' , a ,b)
    datapandas2('BTCUSDT', r'C:\Users\hugom\Desktop\Projecto\DataFrame\sem_ad\r55.csv' , a ,b)
    datapandas3('BTCUSDT', r'C:\Users\hugom\Desktop\Projecto\DataFrame\rsi_macd\r55.csv' , a ,b)

start("2019-10-07T14:49" ,"2019-10-07T16:29")
