...
import talib
from talib.abstract import RSI, MACD, ADX, ATR , BBANDS , MA , WCLPRICE, AVGPRICE, STOCHRSI, ADOSC  
import numpy as np


def indicadores (o , c , h , l, v) : # open, close, high , low, volume
    lista1 = np.array(o)
    lista2 = np.array(c)
    lista3 = np.array(h)
    lista4 = np.array(l)
    ...
    inputs = {'open' : lista1 , 'close' : lista2 , 'high' : lista3 , 'low' : lista4, 'volume' :lista5}
    ...
    return rsi , adx , atr , ma50 , ma100, ma200, wcl, macd, macdsignal, macdhist, upperband, middleband, lowerband, avg, fastk, fastd, ad
