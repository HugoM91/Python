...
import talib
from talib.abstract import RSI, MACD, ADX, ATR , BBANDS , EMA , WCLPRICE, AVGPRICE, STOCHRSI
import numpy as np
...
def indicadores (o , c , h , l) : # open, close, high , low
    ...
    ma50 = EMA(inputs, timeperiod=50)
    ma100 = EMA(inputs, timeperiod=100)
    ma200 = EMA(inputs, timeperiod=200)
    wcl = WCLPRICE(inputs)
    avg = AVGPRICE(inputs)
